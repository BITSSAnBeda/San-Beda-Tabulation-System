...
<html>
    ...
    <nav style="overflow:scroll">
        ...
        <?php
        $qwerty = "SELECT Contestant_ID FROM twotopsixmale";
...
<?php      
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,twotopsixmale.Beauty,twotopsixmale.Intelligence FROM Contestant,twotopsixmale WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'M' AND Contestant.Contestant_ID = twotopsixmale.Contestant_ID Order By Contestant_ID";
...
?>            
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,twotopsixfemale.Beauty,twotopsixfemale.Intelligence FROM Contestant,twotopsixfemale WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'F' AND Contestant.Contestant_ID = twotopsixfemale.Contestant_ID Order By Contestant_ID ASC";
  $result = $con->query($sql);            
  while($res = $result->fetch_assoc()){
