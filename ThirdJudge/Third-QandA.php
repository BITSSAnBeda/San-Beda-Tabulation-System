...
<?php      
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,third_judge_male.QA FROM Contestant,third_judge_male WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'M' AND Contestant.Contestant_ID = third_judge_male.Contestant_ID Order By Contestant_ID ASC";
