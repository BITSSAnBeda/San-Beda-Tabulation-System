...
<html>
    ...
    <nav style="overflow:scroll">
        ...
        <?php
        $qwerty = "SELECT Contestant_ID FROM threetopsixmale";
...
<?php      
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,threetopsixmale.Beauty,threetopsixmale.Intelligence FROM Contestant,threetopsixmale WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'M' AND Contestant.Contestant_ID = threetopsixmale.Contestant_ID Order By Contestant_ID";
...
?>            
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,threetopsixfemale.Beauty,threetopsixfemale.Intelligence FROM Contestant,threetopsixfemale WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'F' AND Contestant.Contestant_ID = threetopsixfemale.Contestant_ID Order By Contestant_ID ASC";
  $result = $con->query($sql);            
  while($res = $result->fetch_assoc()){
