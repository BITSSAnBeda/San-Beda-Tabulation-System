...
<html>
    ...
    <nav style="overflow:scroll">
        ...
        <?php
        $qwerty = "SELECT Contestant_ID FROM seventopsixmale";
...
<?php      
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,seventopsixmale.Beauty,seventopsixmale.Intelligence FROM Contestant,seventopsixmale WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'M' AND Contestant.Contestant_ID = seventopsixmale.Contestant_ID Order By Contestant_ID";
...
?>            
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,seventopsixfemale.Beauty,seventopsixfemale.Intelligence FROM Contestant,seventopsixfemale WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'F' AND Contestant.Contestant_ID = seventopsixfemale.Contestant_ID Order By Contestant_ID ASC";
  $result = $con->query($sql);            
  while($res = $result->fetch_assoc()){
