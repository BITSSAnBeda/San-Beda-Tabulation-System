...
<?php      
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,fourtopsixmale.Beauty,fourtopsixmale.Intelligence FROM Contestant,fourtopsixmale WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'M' AND Contestant.Contestant_ID = fourtopsixmale.Contestant_ID Order By Contestant_ID";
...
?>            
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,fourtopsixfemale.Beauty,fourtopsixfemale.Intelligence FROM Contestant,fourtopsixfemale WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'F' AND Contestant.Contestant_ID = fourtopsixfemale.Contestant_ID Order By Contestant_ID ASC";
  $result = $con->query($sql);            
  while($res = $result->fetch_assoc()){
