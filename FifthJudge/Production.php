...
<html>
    ...
    <nav style="overflow:scroll">
        ...
        <?php
        $qwerty = "SELECT Contestant_ID FROM fifth_judge_male Order By Contestant_ID ASC";
...
<body>
    <div class="main">
        ...
        <div class="page-title top6f center">
            <p class="title center inbold margin0 allcaps">Judging for Production</p>
            <p class="description margin0 marginside"> Production 20% ( Ceiling Grade = 15% )<br></p>
        </div>
...
<?php      
  ...
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,fifth_judge_male.Production FROM Contestant,fifth_judge_male WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'M' AND Contestant.Contestant_ID = fifth_judge_male.Contestant_ID Order By Contestant_ID ASC";
            ...
            <div class="row-clear">
                <div class="tabulation-male" id="<?php echo $res['Contestant_ID'] ?>"> 
                    ...
                    <div class="tabulation-form fleft">
                        <form method="POST" action="ProdSubmit.php">
                            ...
                            <div class="top6-form-group">
                                ...
                                <input type="number" value="<?php echo $res['Production']; ?>" disabled>
                                ...
                                <input type="hidden" value="<?php echo $res['Contestant_ID']; ?>" name="one_prodmaleid">
                                <input type="hidden" value="<?php echo $res['Last_Name']; ?>" name="one_prodmalelast">
                                <input type="number" name="one_prodmalescore" class="score" placeholder="20%" min="15" max="20" required>
...
?>      
<?php
  $sql = "SELECT Contestant.Contestant_ID,Contestant.Last_Name,Contestant.First_Name,Contestant.Section,Contestant.Gender,fifth_judge_female.Production FROM Contestant,fifth_judge_female WHERE Contestant.Contestant_ID = $a AND  Contestant.Gender = 'F' AND Contestant.Contestant_ID = fifth_judge_female.Contestant_ID Order By Contestant_ID ASC";
  $result = $con->query($sql);            
  while($res = $result->fetch_assoc()){
...
?>   
                <div class="tabulation-female" id="female1"> 
                    ...
                    <div class="contestant fleft">
                     ...
                     <div class="tabulation-form fleft">
                        <form method="POST" action="ProdFemale.php">
                            ...
                            <label>Production</label><br>    
                                ...
                                <input type="hidden" value="<?php echo $res['Contestant_ID']; ?>" name="one_prodfmaleid">
                                <input type="hidden" value="<?php echo $res['Last_Name']; ?>" name="one_prodfmalelast">
                                <input type="number" name="one_prodfmalescore" class="score" placeholder="20%" min="15" max="20" required>
...
?>
            <div style="margin-top:50px;margin-bottom:50px;margin-left:530px;">
                ...
                <a href="First-CasualWear.php" class="btn" style="font-size:30px;">NEXT</a>
