...
//First
$total1 = "SELECT first_judge_male.Contestant_ID , first_judge_male.Last_Name,(first_judge_male.CasualWear + first_judge_male.FormalWear + first_judge_male.Production + first_judge_male.QA)as Total FROM first_judge_male";
...
<table>
        ...
        ?>
                    <tr>
                        ...
                        <td><?php echo number_format((float)$totalScore, 2, '.', ''); ?></td>
                        <td><?php /*Insert overall*/ ?></td>
                        <td><?php /*Insert overall*/ ?></td>
