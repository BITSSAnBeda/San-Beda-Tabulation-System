...
//First
$total1 = "SELECT first_judge_male.Contestant_ID , first_judge_male.Last_Name,(first_judge_male.CasualWear)as Total FROM first_judge_male";
...
$total2 = "SELECT first_judge_female.Contestant_ID , first_judge_female.Last_Name,(first_judge_female.CasualWear)as Total FROM first_judge_female";
...
//Second
$total3 = "SELECT second_judge_male.Contestant_ID , second_judge_male.Last_Name,(second_judge_male.CasualWear)as Total FROM second_judge_male";
...
$total4 = "SELECT second_judge_female.Contestant_ID , second_judge_female.Last_Name,(second_judge_female.CasualWear)as Total FROM second_judge_female";
...
//Third
$total5 = "SELECT third_judge_male.Contestant_ID , third_judge_male.Last_Name,(third_judge_male.CasualWear)as Total FROM third_judge_male";
...
$total6 = "SELECT third_judge_female.Contestant_ID , third_judge_female.Last_Name,(third_judge_female.CasualWear)as Total FROM third_judge_female";
...
//Fourth
$total7 = "SELECT fourth_judge_male.Contestant_ID , fourth_judge_male.Last_Name,(fourth_judge_male.CasualWear)as Total FROM fourth_judge_male";
...
$total8 = "SELECT fourth_judge_female.Contestant_ID , fourth_judge_female.Last_Name,(fourth_judge_female.CasualWear)as Total FROM fourth_judge_female";
...
//Fifth
$total9 = "SELECT fifth_judge_male.Contestant_ID , fifth_judge_male.Last_Name,(fifth_judge_male.CasualWear)as Total FROM fifth_judge_male";
...
$total10 = "SELECT fifth_judge_female.Contestant_ID , fifth_judge_female.Last_Name,(fifth_judge_female.CasualWear)as Total FROM fifth_judge_female";
...
//Sixth
$total11 = "SELECT sixth_judge_male.Contestant_ID , sixth_judge_male.Last_Name,(sixth_judge_male.CasualWear)as Total FROM sixth_judge_male";
...
$total12 = "SELECT sixth_judge_female.Contestant_ID , sixth_judge_female.Last_Name,(sixth_judge_female.CasualWear)as Total FROM sixth_judge_female";
...
//Seventh
$total13 = "SELECT seven_judge_male.Contestant_ID , seven_judge_male.Last_Name,(seven_judge_male.CasualWear)as Total FROM seven_judge_male";
...
$total14 = "SELECT seven_judge_female.Contestant_ID , seven_judge_female.Last_Name,(seven_judge_female.CasualWear)as Total FROM seven_judge_female";
...
<body>
    <div class="main">
        ...
        <div class="tabulation">
            ...
            <!--Contestant 1-->
            <div class="row-clear">
                <center><h1>Casual - MALE Results</h1></center>
                <br/>
<table>
                    <tr>
        ...
        ?>
            ...
            ?>
                  ...
                  <center><h1>Casual - FEMALE Results</h1></center>
                <br/>
<table>
                    <tr>
                        <th>Contestant Number</th>
